...
PAs <- st_read(here::here("Data/processed/herd_shapefile_outline.shp")) %>% 
  dplyr::filter(. , NAME == "Yellowstone National Park" | NAME == "FORT PECK") %>% 
...
pa.cents$lab <- c("Yellowstone National Park", "Fort Peck")
...
cowplot::save_plot(here::here("plots/fig1_5_YNP_FP.png"), plot =p.combined, base_height = 4)
